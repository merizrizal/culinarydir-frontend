...
Pjax::begin([
    ...
    'linkSelector' => '#pagination-result-order a',
    'options' => ['id' => 'pjax-result-order'],
    'timeout' => 7000,
]);
...
$linkPager = LinkPager::widget([
    ...
    'options' => ['id' => 'pagination-result-order', 'class' => 'pagination'],
]); ?>
                	...
                	<div class="row mb-10">
                		<div class="col-xs-12">
                			<div class="box box-small">
                    			...
                    			<div class="row">
                    				<div class="col-sm-5 col-xs-7 col direct-link" data-link="<?= Yii::$app->urlManager->createUrl(['page/detail', 'id' => $dataBusiness['id']]) ?>">
                    				...
                    				<div class="col-sm-7 col-xs-12 col">
                    					<div class="short-desc">
                    						...
                    						<div class="row">
                    							...
                    							<div class="col-sm-2 col visible-lg visible-md visible-sm text-center">
...
$jscript = '
    ...
    $("#pjax-result-order").off("pjax:send");
    $("#pjax-result-order").on("pjax:send", function() {
        
        $(".box-place").children(".overlay").show();
        $(".box-place").children(".loading-img").show();
    });

    $("#pjax-result-order").off("pjax:complete");
    $("#pjax-result-order").on("pjax:complete", function() {
    ...
    $("#pjax-result-order").off("pjax:error");
    $("#pjax-result-order").on("pjax:error", function (event) {
