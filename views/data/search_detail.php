...
if ($type == Yii::t('app', 'favorite')):

    echo Html::beginForm(['page/result-list', 'searchType' => Yii::t('app', 'favorite'), 'city' => 'city_name'], 'get', [
...
elseif ($type == Yii::t('app', 'promo')):

    echo Html::beginForm(['page/result-list', 'searchType' => Yii::t('app', 'promo'), 'city' => 'city_name'], 'get', [
...
elseif ($type == Yii::t('app', 'online-order')):

    echo Html::beginForm(['page/result-list', 'searchType' => Yii::t('app', 'online-order'), 'city' => 'city_name'], 'get', [
        'class' => 'search-order'
    ]); ?>
