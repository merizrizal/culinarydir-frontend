...
class OrderActionController extends base\BaseController
{
    ...
    public function actionChangeQty()
    {
        ...
        if ($flag) {
            ...
            $result['success'] = true;
            $result['total_price'] = !empty($post['page']) ? Yii::$app->formatter->asCurrency($modelTransactionSession->total_price) : $modelTransactionSession->total_price;
            $result['total_amount'] = $modelTransactionSession->total_amount;
        } else {
    ...
    public function actionRemoveItem()
    {
        ...
        if ($flag) {
            ...
            $result['success'] = true;
            $result['total_price'] = !empty(Yii::$app->request->post()['page']) ? Yii::$app->formatter->asCurrency($modelTransactionSession->total_price) : $modelTransactionSession->total_price;
            $result['total_amount'] = $modelTransactionSession->total_amount;
        } else {
